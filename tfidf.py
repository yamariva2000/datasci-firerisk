...
def model_corpus(load=False,docs=None):
    ...
    model=CountVectorizer(analyzer='char_wb',ngram_range=(2,2),min_df=1)
...
if __name__=='__main__':
    ...
    search=['2351 29th street 94116','1495 25th ave','50 california 94111','5 california st','1 market','one market','16th ave','ocean ave','santa rosa','1431 grant ave']
    find_address(search)